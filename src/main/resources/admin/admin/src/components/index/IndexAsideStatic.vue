  ...
  <el-aside class="index-aside" height="100vh" width="230px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#FCFCFC">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#FCFCFC" text-color="var(--publicMainColor)" active-text-color="#000000" default-active="0">
...
<style lang="scss" scoped>
  ...
  .index-aside {
    ...
    box-shadow: 2px 0 15px rgba(74, 144, 226, 0.08);
    ...
    /deep/ .el-menu {
      ...
      .el-menu-item {
        ...
        &:hover {
          ...
          color: $fresh-blue !important;
        }
        
        &.is-active {
          background: linear-gradient(135deg, $fresh-blue 0%, #5B9BD5 100%) !important;
